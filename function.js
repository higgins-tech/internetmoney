/* ── DOWNLOAD LOGIC ── */
const APK_FILE = 'internetmoney.apk'; // ← replace with your actual filename
...
const platformContent = {
    ...
    windows: {
        ...
        steps: [
            ...
            { icon: '③', text: 'Enable <strong>Developer Mode</strong> in WSA settings, then run:<br><code style="background:#0a0a0f;padding:2px 7px;border-radius:4px;font-size:12px;">adb install internetmoney.apk</code>' },
    ...
    mac: {
        ...
        steps: [
            ...
            { icon: '③', text: 'Drag and drop the APK onto the emulator window, or run:<br><code style="background:#0a0a0f;padding:2px 7px;border-radius:4px;font-size:12px;">adb install internetmoney.apk</code>' },
        ],
        toastSub: 'Check your Downloads folder.'
    },
    linux: {
        ...
        steps: [
            ...
            { icon: '③', text: 'Run: <code style="background:#0a0a0f;padding:2px 7px;border-radius:4px;font-size:12px;">adb install internetmoney.apk</code>' },
        ],
        toastSub: 'Check your Downloads folder.'
    },
    unknown: {
...
function handleDownload() {
    ...
    stepsEl.innerHTML = content.steps.map(s => `
      <div style="display:flex;gap:12px;align-items:flex-start;background:#111118;border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:12px 14px;">
        <span style="font-family:'Syne',sans-serif;font-weight:800;font-size:16px;color:#ffdb0c;flex-shrink:0;line-height:1.4;">${s.icon}</span>
